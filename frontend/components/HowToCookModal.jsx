  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <button className="hover:text-orange-600 cursor-pointer transition-colors flex items-center gap-1.5 text-sm font-medium text-stone-600">
      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle className="text-2xl font-serif cursor-pointer font-bold flex items-center gap-2">
